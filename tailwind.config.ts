...
// Tremor's officially documented theme + safelist, required because
// Tremor builds several utility class names (colors) dynamically at
// runtime, which Tailwind's static analyzer can't otherwise discover.
// https://npm.tremor.so/docs/getting-started/installation
const config: Config = {
  darkMode: "class",
  content: [
    "./src/**/*.{js,ts,jsx,tsx}",
